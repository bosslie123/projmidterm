    ...
    <form action="{{ url('/logout') }}" method="get">
        ...
        <div class="row">
            ...
            <div class="col-md-5 col-offset-5">
                <h4 style="text-align: center">Marklie E. Caresosa BSIT-4</h4>
                <hr>
                <h3 style="text-align: center">About</h3>
                <p style="margin-left: 10%">Address:<strong>Panggangan, Calape, Bohol</strong></p>
                <p style="margin-left: 10%">Email: <strong>bosslie1234@gmail.com</strong></p>
                <p style="margin-left: 10%">School: <strong>Mater Dei College</strong></p>
                <p style="margin-left: 10%">School ID: <strong>10551-2T18</strong></p>
